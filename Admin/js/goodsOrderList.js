...
define(["commJs"], function (comm) {
    ...
    ////////////////////////////////////Form data
    var fields = ['title', 'userId', 'price', 'count', 'status'];

    function getParam() {
        var param = {};
        $.each(fields.concat(['goodItemId', 'title', 'userName', 'userPhone']), function (idx, field) {
            var val = $.trim($('#' + field).val());
            if (val) param[field] = val;
        });
        //if (pickedDate) param['orderTime'] = pickedDate;
    ...
    function resetForm() {
        $.each(fields.concat(['goodItemId', 'orderTime', 'title', 'userName', 'userPhone']), function (idx, field) {
            $('#' + field).val('');
        });
    ...
    function setSearchForm(row) {
        var fields = ['title', 'userName', 'userPhone'];
        $.each(fields, function (idx, field) {
            if ($('#' + field) && row[field]) $('#' + field).val(row[field]);
        });
    }
