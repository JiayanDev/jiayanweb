...
define(["commJs"], function (comm) {
    ...
    function getList() {
        var data = {};
        var id = $("#recommendTopicId").val();
        if (id) {
            data["id"] = id;
        }
        comm.io.get({
            url: comm.config.BASEPATH + 'rec_topic/list',
            data: data,
            success: function (d) {
                renderList(d);
            }
    ...
    function bindEvent() {
        ...
        $('#_submit').click(function () {
            ...
            if (id) {
                ...
                doSubmit("rec_topic/create", params, "添加成功");
            }
            return false;
        });
    }
    ...
    var fields = ['title', 'itemId', 'desc', 'status'];
